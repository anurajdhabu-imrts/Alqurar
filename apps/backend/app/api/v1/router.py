...
from app.api.v1 import auth, users, roles, permissions, documents, assignments, clauses, projects, project_documents, project_clauses, project_queries, client_profiles, delay_events, chronology, admissibility, portal, proposals, client_proposals, dashboard, knowledge, employees, costing
...
api_router.include_router(project_queries.router, prefix="/project-queries", tags=["project-queries"])
...
api_router.include_router(chronology.router, prefix="/chronology", tags=["chronology"])
api_router.include_router(admissibility.router, prefix="/admissibility", tags=["admissibility"])
