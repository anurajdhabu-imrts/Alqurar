...
from app.api.v1 import auth, users, roles, permissions, documents, assignments, clauses, projects, project_documents, project_clauses, project_queries, proposal_checklist, methodology, client_profiles, delay_events, chronology, admissibility, portal, proposals, client_proposals, dashboard, knowledge, employees, costing
...
api_router.include_router(proposal_checklist.router, prefix="/proposal-checklist", tags=["proposal-checklist"])
